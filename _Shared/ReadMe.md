...
<a href="https://www.codecogs.com/eqnedit.php?latex=\text{s.t.&space;}&space;\textit{\mathbf{L}}_\mathbf{\alpha}\leq&space;\mathbf{\alpha}&space;\leq&space;\textit{\mathbf{U}}_\mathbf{\alpha}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\text{s.t.&space;}&space;\textit{\mathbf{L}}_\mathbf{\alpha}\leq&space;\mathbf{\alpha}&space;\leq&space;\textit{\mathbf{U}}_\mathbf{\alpha}" title="\text{s.t. } \textit{\mathbf{L}}_\mathbf{\alpha}\leq \mathbf{\alpha} \leq \textit{\mathbf{U}}_\mathbf{\alpha}" /></a>
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\text{&space;&space;s.t.&space;}&space;\textit{\mathbf{L}}_\mathbf{\alpha}\leq&space;\mathbf{\alpha}&space;\leq&space;\textit{\mathbf{U}}_\mathbf{\alpha}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\text{s.t.&space;}&space;\textit{\mathbf{L}}_\mathbf{\alpha}\leq&space;\mathbf{\alpha}&space;\leq&space;\textit{\mathbf{U}}_\mathbf{\alpha}" title="\text{s.t. } \textit{\mathbf{L}}_\mathbf{\alpha}\leq \mathbf{\alpha} \leq \textit{\mathbf{U}}_\mathbf{\alpha}" /></a>
### Output Arguments
